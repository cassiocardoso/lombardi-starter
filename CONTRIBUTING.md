# Contributing to lombardi-starter

Love lombardi-starter and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/cassiocardoso/lombardi-starter/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/lombardi-starter.git
    # Navigate to the newly cloned directory
    cd lombardi-starter
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/cassiocardoso/lombardi-starter.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/cassiocardoso/lombardi-starter/blob/master/LICENSE.md).
